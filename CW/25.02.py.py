...
'''
Homework
1. Почитать о лейблах
2. Написать программу, которая будет сохранять введенный текст
3. Модифицируйте код из задачи два, добавив возможность очищать текст из поля
'''
